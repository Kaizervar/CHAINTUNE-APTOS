module chain_tune::Marketplace {
    ...
    // public entry fun batch_mint_profile_nft(receiver:&signer, artist_name: vector<u8>, cid: vector<u8>, desc: vector<vector<u8>>, artistImage: vector<u8>, no_of_nfts: u64) acquires ModuleData, TokenCap {
    //     let i: u64 = 0;
    //     while(i < no_of_nfts) {
    //         let desc_tok: vector<u8> = *vector::borrow(& desc,(i as u64));
    //         mint_profile_nft(receiver, artist_name, cid, desc_tok, artistImage, no_of_nfts);
    //         i = i + 1;
    //     }
    // }
    ...
    public entry fun mint_profile_nft(receiver:&signer, artist_name: vector<u8>, cid: vector<u8>, desc: vector<u8>, artistImage: vector<u8>) acquires ModuleData, TokenCap {
        ...
        let token_data_id = token::create_tokendata(
            ...
            1,
            // c_id,
            string::utf8(b"https://tan-worldwide-macaw-428.mypinata.cloud/ipfs/QmeV7RkFtYezdDy9a8XqtR89W1R7npNrMuNCj7Hdcv1zdj"),
            @chain_tune,
            1,
            1,
...
// public entry fun batch_mint_profile_nft(receiver:&signer, artist_name: vector<u8>, cid: vector<u8>, desc: vector<u8>, artistImage: vector<u8>, no_of_nfts: u8) acquires ModuleData, TokenCap {
//         let i: u8 = 0;
//         while(i < no_of_nfts) {
//             mint_profile_nft(receiver, artist_name, cid, disc, artistImage, no_of_nfts);
//             i = i + 1;
//         }
//     }

    // public fun mint_profile_nft(receiver:&signer, artist_name: vector<u8>, cid: vector<u8>, desc: vector<u8>, artistImage: vector<u8>, max_no_of_nfts: u8) acquires ModuleData, TokenCap {
    //     let receiver_addr = signer::address_of(receiver);
