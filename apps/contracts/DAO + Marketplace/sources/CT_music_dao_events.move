// module chain_tune::music_dao_events {
...
//             property_versions,
//         };
//         let dao_event_store = borrow_global_mut<DAOEventStoreV1>(music_dao);
...
//         let dao_event_store = borrow_global_mut<DAOEventStoreV1>(music_dao_address);
...
//     public(friend) fun emit_resolve_event(proposal_id: u64, music_dao: address, result: u8) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_admin_offer_event(admin: address, new_admin: address, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_admin_claim_event(admin: address, new_admin: address, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_admin_offer_cancel_event(admin: address, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_change_name_event(old_name: String, new_name: String, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_change_threshold_event(old_threshold: u64, new_threshold: u64, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_change_duration_event(old_duration: u64, new_duration: u64, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_change_voting_power_event(old_power: u64, new_power: u64, music_dao: address) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_admin_veto_event(proposal_id: u64, admin: address, music_dao: address, reason: String) acquires DAOEventStoreV1 {
...
//     public(friend) fun emit_admin_resolve_event(proposal_id: u64, admin: address, music_dao: address, reason: String) acquires DAOEventStoreV1 {
