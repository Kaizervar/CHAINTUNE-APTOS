module chain_tune::Marketplace {
    ...
    public entry fun batch_mint_profile_nft(receiver:&signer, artist_name: vector<u8>, cid: vector<u8>, disc: vector<u8>, artistImage: vector<u8>, no_of_nfts: u8) acquires ModuleData, TokenCap {
        let i: u8 = 0;
        while(i < no_of_nfts) {
            mint_profile_nft(receiver, artist_name, cid, disc, artistImage);
            i = i + 1;
        }
    }
